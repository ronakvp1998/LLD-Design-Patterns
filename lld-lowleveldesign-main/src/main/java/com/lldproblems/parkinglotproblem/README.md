...
You can run the application directly from your IDE by executing the `main` method in `com.lldproblems.parkinglotproblem.Main`. Once started, use the `help` command in the interactive prompt to see all available actions.
